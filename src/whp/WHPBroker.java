...
//	
//	/** Send pubnub message, topic and message must be provided. */
//	public Answer whpPubnubTest( double usIdD, Date usTimestamp, String channel, String messageToSend ) {
//		
//		long usId = Double.doubleToLongBits( usIdD );
//		if( ! MdbId.isIdUserSession( usId ) ) return null;
...
//		
//		Context context = authenticate( "whpPubNubTest", usId, usTimestamp );
//		if( context == null ) return null;
//		
//		context.addLog( "channel " + channel );
//		context.addLog( "messageToSend " + messageToSend );
//		
//		String pubKey = "pub-c-80feba25-05f6-41bb-b527-f8d539780814";
//		String subKey = "sub-c-109950f0-a097-11e5-b53d-0619f8945a4f";
//		 
//		JSONObject jMessage = new JSONObject();
//		try {
//			jMessage.put("text", messageToSend );
//		/*
//		 * jMessage.put("title", "Java Client PubNub";
//		 * jMessage.put("some_val",
//		 * "This is a push to all users! Fighting!" jMessage.put("url",
//		 * "http://www.pubnub.com"
//		 */
//		} catch (org.json.JSONException jsonError) {
//			context.addLog( "jMessage error" ); 
//		}
// 
//		JSONArray jArray = null;
//		
//		int publishCount = 0;
//		while( publishCount < 2 ) {
//			
//			publishCount++;
//			
...
//				context.addLog( "pubnum instanced" );
//			}
//			
//			try {
//				Thread.sleep( 10 );
//			} catch (InterruptedException e1) {
//				context.addRcLog( RLE.ERR, "sleep error" );
//				break;
//			}
//			
//			jArray = pubnub.publish( channel, jMessage );
//			
//			if( jArray == null ) {
//				context.addRcLog( RLE.ERR, "message not sent to pubnum" );
//				break;
//			}
//			else {
//				
//				String str0 = null;
//				try {
//					str0 = jArray.toString();
//					str0 = jArray.getString( 0 );
//				} catch (JSONException e) {
//					context.addLog( "jArray.getString( 0 ) error" );
//					break;
//				}
//				
////				if( jArray.length() != 3 && ( str0.length() < 6 || str0.substring( 0,  ( 6 - 0 ) ).equals( "Error:" ) ) ) {
//				if( jArray.length() != 3 ) {
//					context.addLog( "published not return 3 fields: " + str0 );
//					pubnub = null;	// reset pubnum instance ?
//					continue;
//				}
//				
//				str0 = jArray.toString();
//				context.addLog( jArray.length() + ": " + str0 );
//				break;
//			}
//		}
//		
